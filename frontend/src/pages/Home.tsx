    ...
    <div className="space-y-10 page-enter">
      <section className="py-10">
        <div className="container-page">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight animate-fade-in">Time-Banked Marketplace</h1>
          <p className="text-neutral-300 max-w-2xl mb-6 animate-fade-in" style={{ animationDelay: '200ms' }}>
            Exchange skills and services using TimeToken (TTK). 1 hour = 1 TTK. Trustless escrow ensures fair payments.
          </p>
      ...
      <section className="grid md:grid-cols-3 gap-4">
        <div className="card animate-slide-in">
          <h3 className="font-semibold mb-1 text-indigo-400">Wallet-first</h3>
        ...
        <div className="card animate-slide-in" style={{ animationDelay: '200ms' }}>
          <h3 className="font-semibold mb-1 text-indigo-400">TimeToken (TTK)</h3>
        ...
        <div className="card animate-slide-in" style={{ animationDelay: '400ms' }}>
          <h3 className="font-semibold mb-1 text-indigo-400">Secure Escrow</h3>
